...
//        TimeVTxt.setText(generalFunc.getJsonValue("tTripRequestDate", data));
        TimeVTxt.setText(generalFunc.getDateFormatedType(generalFunc.getJsonValue("tTripRequestDate", data), Utils.OriginalDateFormate, Utils.getDetailDateFormat()));
        ...
        if (generalFunc.getJsonValue("eType", data).equalsIgnoreCase(Utils.CabGeneralType_Deliver) ||
                generalFunc.getJsonValue("eType", data).equalsIgnoreCase("delivery")) {
