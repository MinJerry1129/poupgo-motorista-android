...
public class AddVehicleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getStringExtra("seltype") != null) {
            selectedtype = getIntent().getStringExtra("seltype");
        }
            ...
            if (isHadicap != null && !isHadicap.equals("")) {
                if (isHadicap.equalsIgnoreCase("Yes")) {
                    ...
                    if (selectedtype != null && !selectedtype.equalsIgnoreCase("Delivery")) {
...
//        if (!iDriverVehicleId.equals("")) {
        ...
        if (getIntent().getStringExtra("vRentalCarType") != null && !getIntent().getStringExtra("vRentalCarType").equals("")) {
            vRentalCarType = getIntent().getStringExtra("vRentalCarType").split(",");
        }
        ...
        for (int i = 0; i < vehicletypelist.length(); i++) {
            ...
            if (vCarTypes != null && vCarTypes.length > 0) {
                ...
                if (ischeck.equalsIgnoreCase("true") || Arrays.asList(vCarTypes).contains(generalFunc.getJsonValue("iVehicleTypeId", obj.toString()))) {
                    ...
                    if (generalFunc.getJsonValue("eRental", obj.toString()) != null && generalFunc.getJsonValue("eRental", obj.toString()).equalsIgnoreCase("yes")) {
            ...
            if (vRentalCarType != null && vRentalCarType.length > 0) {
                ...
                if (Arrays.asList(vRentalCarType).contains(generalFunc.getJsonValue("iVehicleTypeId", obj.toString()))) {
            ...
            rentalchkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                @Override
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    rentalcarTypesStatusArr.set(finalI, isChecked);
                }
            });
...
//        }
    ...
    public void addVehicle(String iMakeId, String iModelId, String vCarType) {
        ...
        for (int i = 0; i < rentalcarTypesStatusArr.size(); i++) {
            if (rentalcarTypesStatusArr.get(i) == true) {
        ...
        if (getIntent().getStringExtra("seltype") != null) {
            parameters.put("eType", getIntent().getStringExtra("seltype"));
        } else {
            parameters.put("eType", app_type);
        }
            ...
            public void setResponse(final String responseString) {
                ...
                if (responseString != null && !responseString.equals("")) {
                    ...
                    if (isDataAvail == true) {
                        ...
                        try {
                            if (generalFunc.getJsonValue("VehicleInsertId", responseString) != null) {
                                tempiDriverVehicleId = generalFunc.getJsonValue("VehicleInsertId", responseString);
                            }
                        } catch (Exception e) {
