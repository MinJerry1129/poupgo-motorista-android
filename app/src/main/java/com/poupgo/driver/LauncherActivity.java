            ...
            public void setResponse(String responseString) {
                ...
                if (responseString != null && !responseString.equals("")) {
                    ...
                    if (isDataAvail == true) {
                        ...
                        generalFunc.storedata(CommonUtilities.REFERRAL_SCHEME_ENABLE, generalFunc.getJsonValue("REFERRAL_SCHEME_ENABLE", responseString));
                        generalFunc.storedata(CommonUtilities.APP_AUDIO_FILE, generalFunc.getJsonValue("APP_AUDIO_FILE", responseString));
            ...
            public void setResponse(final String responseString) {
                ...
                if (responseString != null && !responseString.equals("")) {
                    ...
                    if (isDataAvail == true) {
                        ...
                        generalFunc.storedata(CommonUtilities.APP_AUDIO_FILE, generalFunc.getJsonValue("APP_AUDIO_FILE", message));
                        ...
                        //provider can set the work location
