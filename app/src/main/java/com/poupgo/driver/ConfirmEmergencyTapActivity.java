...
//                        generalFunc.showGeneralMessage("",
//                                generalFunc.retrieveLangLBl("", generalFunc.getJsonValue(CommonUtilities.message_str, responseString)));
                        if (generalFunc.getJsonValue(CommonUtilities.message_str_one, responseString).equalsIgnoreCase("SmsError")) {
                            generalFunc.showGeneralMessage("", generalFunc.getJsonValue(CommonUtilities.message_str, responseString));
                        }
                        else
                        {
