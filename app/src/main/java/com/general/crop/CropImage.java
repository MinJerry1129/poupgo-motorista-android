...
import com.poupgo.driver.CropImageActivity;
...
public final class CropImage {
    ...
    public static Intent getPickImageChooserIntent(@NonNull Context context) {
        return getPickImageChooserIntent(
                context, context.getString(com.general.files.R.string.pick_image_intent_chooser_title), false, true);
    }
    ...
    public static final class ActivityBuilder {
        ...
        public void start(@NonNull Context context, @NonNull SignUpFragment fragment) {
        ...
        public ActivityBuilder setDoneButtonText(String done_str) {
            this.mOptions.done_str = done_str;
            return this;
        }
        public ActivityBuilder setCancelButtonText(String cancel_str) {
            this.mOptions.cancel_str = cancel_str;
            return this;
        }
        /**
