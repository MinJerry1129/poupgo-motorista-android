...
public class CropImageOptions implements Parcelable {
    ...
    public CharSequence done_str;

    public CharSequence cancel_str;
    ...
    protected CropImageOptions(Parcel in) {
        ...
        done_str = TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(in);
        cancel_str = TextUtils.CHAR_SEQUENCE_CREATOR.createFromParcel(in);
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        TextUtils.writeToParcel(done_str, dest, flags);
        TextUtils.writeToParcel(cancel_str, dest, flags);
