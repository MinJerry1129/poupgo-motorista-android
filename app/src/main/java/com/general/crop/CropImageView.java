...
import com.general.files.ExifInterface;
...
public class CropImageView extends FrameLayout {
    ...
    public interface OnBitmapLoadList {
        void onBitmapLoad(Bitmap var1);
    }
    CropImageView.OnBitmapLoadList a;

    public void setBitmapLoadList(OnBitmapLoadList onBitmapLoadList) {
        this.a = onBitmapLoadList;
    }
