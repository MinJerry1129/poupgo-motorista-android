    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            if (item.get("selectdtime") != null && !item.get("selectdtime").equalsIgnoreCase("")) {
                ...
                viewHolder.etypeTxt.setText(generalFunc.getDateFormatedType(item.get("dBooking_dateOrig"), Utils.OriginalDateFormate, Utils.getDetailDateFormat()));
            } else {
                viewHolder.dateTxt.setText(generalFunc.getDateFormatedType(item.get("dBooking_dateOrig"), Utils.OriginalDateFormate, Utils.getDetailDateFormat()));
