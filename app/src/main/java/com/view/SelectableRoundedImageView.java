...
public class SelectableRoundedImageView extends AppCompatImageView {
    ...
    static class SelectableRoundedCornerDrawable extends Drawable {
        ...
        public static Bitmap drawableToBitmap(Drawable drawable) {
            ...
            try {
                Bitmap bitmap2 = Bitmap.createBitmap(Math.max(drawable.getIntrinsicWidth(), 2), Math.max(drawable.getIntrinsicHeight(), 2), Config.ARGB_8888);
        ...
        private void configureBounds(Canvas canvas) {
            ...
            if (ScaleType.CENTER == this.mScaleType) {
                ...
                if (!(ScaleType.FIT_START == this.mScaleType || ScaleType.FIT_END == this.mScaleType || ScaleType.FIT_CENTER == this.mScaleType)) {
        ...
        private void adjustCanvasForBorder(Canvas canvas) {
            ...
            if (!(ScaleType.FIT_START == this.mScaleType || ScaleType.FIT_END == this.mScaleType || ScaleType.FIT_XY == this.mScaleType || ScaleType.FIT_CENTER == this.mScaleType || ScaleType.CENTER_INSIDE == this.mScaleType)) {
                if (ScaleType.MATRIX != this.mScaleType) {
        ...
        public int getOpacity() {
            if (!(this.mBitmap == null || this.mBitmap.hasAlpha())) {
                if (this.mBitmapPaint.getAlpha() >= 255) {
    ...
    public SelectableRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (this.mLeftTopCornerRadius >= 0.0f && this.mRightTopCornerRadius >= 0.0f && this.mLeftBottomCornerRadius >= 0.0f) {
    ...
    private Drawable resolveResource() {
        ...
        if (this.mResource != 0) {
            try {
                ...
                Utils.printLog(str, stringBuilder.toString());
                this.mResource = 0;
            }
        }
