...
public class CommonUtilities {
    ...
    public static final String MINT_APP_ID = "f30a9c40";
    public static final String package_name = "com.poupgo.driver";

    public static final String SERVER = "http://app-19642.nuvem-us-04.absam.app/";
    public static final String SERVER_FOLDER_PATH = "";
    public static final String SERVER_WEBSERVICE_PATH = SERVER_FOLDER_PATH + "webservice_bepay.php";
    ...
    public static String LANGUAGE_LIST_KEY = "DefaultLanguageValues";
    public static String CURRENCY_LIST_KEY = "DefaultCurrencyValues";
    ...
    public static String APP_AUDIO_FILE = "APP_AUDIO_FILE";
